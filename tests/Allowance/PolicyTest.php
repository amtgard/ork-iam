...
class PolicyTest extends TestCase
{
    ...
    {
        $policyA = new Policy([
            new OrkClaim(OrkServices::ORK, "ORK:1:::::*"),
            new OrkClaim(OrkServices::ORK, "ORK:2:::::*"),
        ]);
        $policyB = new Policy([new OrkClaim(OrkServices::ORK, "ORK:1:::::*")]);
    ...
    public function testWithClaimsDedupesAndReturnsClaims(): void
    {
        $claim1 = new OrkClaim(OrkServices::ORK, "ORK:1:::::*");
        $claim2 = new OrkClaim(OrkServices::ORK, "ORK:2:::::*");
        $duplicate = new OrkClaim(OrkServices::ORK, "ORK:1:::::*");
